          ...
          <div className="trust-section__grid">
            <div className="trust-section__content">
              ...
              <div className="trust-section__text">
                <p>
                  Мы работаем с объектами, где ошибка стоит дорого: подземные части
                  зданий, паркинги, исторические конструкции, кровельные узлы,
                  швы, трещины и зоны активного водопоступления.
                </p>

                <p>
                  В таких работах важны диагностика, аккуратность и ответственность
                  за результат. Поэтому мы опираемся на инженерную логику, реальный
                  опыт объектов и понятную документацию по компании.
                </p>
              </div>
            </div>
