    ...
    <Section className="featured-cases-section" spacing="sm" tone="dark">
      <Container>
        <div className="featured-cases-section__header">
          <SectionHeading
            eyebrow="Кейсы"
            title="Реальные объекты, где были протечки, дефекты и сложные узлы"
            description="В кейсах видно, с какими проблемами обращались заказчики, какие направления работ применялись и какой результат был получен на объекте."
          />
