        ...
        <div className="hero__inner">
          <div className="hero__content">
            <h1 className="hero__title">
              Ремонт и восстановление конструкций с инженерной ответственностью
            </h1>

            <p className="hero__description">
              Работаем с жилыми, коммерческими и историческими объектами, где важны точная диагностика, аккуратное выполнение работ и понятный результат для дальнейшей эксплуатации здания.
            </p>
